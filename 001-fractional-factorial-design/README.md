...
where <img src="http://latex.codecogs.com/svg.latex?&space;\Theta_{k}" border="0"> are independent and identically distributed. They characterize the decion tree in terms of split variables, splitting criteria, and leaves values.
