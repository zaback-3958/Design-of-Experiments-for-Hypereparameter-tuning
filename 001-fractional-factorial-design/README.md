...
<img src="http://latex.codecogs.com/gif.latex?\begin{align*} & E(MS_{E})=&space;\sigma^{2}, & E(MS_{Treatment})=&space;\sigma^{2}+\frac{n\sum_{i=1}^{a}\tau_{i}}{a-1}\end{align*}" border="0"/>
